...
/**
 * @title TestUSDC
 * @notice USDC-like test token for testnet deployment
 * @dev 6 decimals to match real USDC
 */
contract TestUSDC is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    uint8 private constant DECIMALS = 6;

    constructor(
        address initialOwner
    ) ERC20("Test USD Coin", "USDC") Ownable(initialOwner) {
        // Mint initial supply: 1 million USDC
