...
/**
 * @title TestWBTC
 * @notice Wrapped Bitcoin-like test token for testnet deployment
 * @dev 8 decimals to match real WBTC
 */
contract TestWBTC is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    uint8 private constant DECIMALS = 8;

    constructor(
        address initialOwner
    ) ERC20("Test Wrapped Bitcoin", "WBTC") Ownable(initialOwner) {
        // Mint initial supply: 100 WBTC
    ...
    /**
     * @notice Override decimals to return 8 (like real WBTC)
     */
