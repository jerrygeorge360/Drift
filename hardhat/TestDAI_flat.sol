...
// File contracts/tokens/TestDAI.sol
...
/**
 * @title TestDAI
 * @notice DAI-like test token for testnet deployment
 * @dev 18 decimals to match real DAI
 */
contract TestDAI is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    constructor(
        address initialOwner
    ) ERC20("Test Dai Stablecoin", "DAI") Ownable(initialOwner) {
        // Mint initial supply: 1 million DAI
...
// File npm/@openzeppelin/contracts@5.4.0/token/ERC20/extensions/ERC20Pausable.sol
