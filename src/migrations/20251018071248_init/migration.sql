...
-- AddForeignKey
ALTER TABLE "Portfolio" ADD CONSTRAINT "Portfolio_smartAccountId_fkey" FOREIGN KEY ("smartAccountId") REFERENCES "SmartAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
